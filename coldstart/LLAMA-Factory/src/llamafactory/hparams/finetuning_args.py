...
class FinetuningArguments(
    ...
    enable_entropy_sft: bool = field(
        default=False,
        metadata={"help": "Whether or not to enable entropy sft."},
    )
    token_ratio: float = field(
        default=0.2,
        metadata={"help": "The ratio of the tokens for sft."},
    )
    entropy_coef: float = field(
        default=1.0,
        metadata={"help": "The coefficient of entropy for entropy sft."},
    )
