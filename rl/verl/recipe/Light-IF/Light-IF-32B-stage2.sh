MODEL_PATH="models/Light-IF-32B-stage1"

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=data/rl-stagte2.parquet \
    data.val_files=data/superclue.parquet \
    data.train_batch_size=352 \
    ...
    actor_rollout_ref.actor.ppo_mini_batch_size=88 \
    ...
    trainer.experiment_name='Light-IF-32B-stage2' \
